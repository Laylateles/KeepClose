...
class BluetoothServiceKeepClose {
  ...
  print(
    "RECONEXÃO: Bluetooth pronto = $estadoBluetooth",
  );
  ...
  assinatura =
      FlutterBluePlus.onScanResults.listen((resultados) {
    for (final resultado in resultados) {
      ...
      if (idEncontrado == idBluetooth) {
        ...
        print(
          "RECONEXÃO: tag encontrada $idEncontrado",
        );
      }
    }
  });
  ...
  try {
    ...
    if (device == null) {
      print(
        "RECONEXÃO: tag $idBluetooth não encontrada",
      );
      return;
    }
    ...
    print(
      "RECONEXÃO: conectado com sucesso",
    );
  } catch (erro) {
    print(
      "RECONEXÃO ERRO: $erro",
